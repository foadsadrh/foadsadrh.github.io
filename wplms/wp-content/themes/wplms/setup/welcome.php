		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					...
					<script>
						var demo_plugins = <?php echo json_encode($demo_plugins);?>;
			...
			<div class="changelog about-integrations">
				...
				<iframe width="100%" height="480" src="http://www.youtube.com/embed/<?php echo apply_filters('wplms_one_click_setup_video','C0RQO3-tjAI');?>" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="changelog">
	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="https://wplms.io/support/knowledge-base/3-5/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4>New Demo demo10</h4>
						<p>First demo built using Visual Composer.</p>
						<a href="https://wplms.io/demos/demo10" class="button"><?php _e( 'Check demo', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						...
						<p style="max-height: 320px; overflow: hidden;">
							<img src="http://wplms.io/demos/demo1/wp-content/uploads/2018/05/demo10.png">
						</p>
						<p>Available in demo switcher.</p>
						<a href="wplms.io/demos/demo10" class="button" target="_blank">Demo Link</a>
					</div>
					<div>
						<h4>Two options for installation</h4>
						<p style="max-height: 320px; overflow: hidden;">
							<img src="http://wplms.io/demos/demo1/wp-content/uploads/2018/05/setup.png" >
						</p>
						
					</div>
					<div class="last-feature">
						<h4>Apha option for colors in customizer</h4>
						<p style="max-height: 320px; overflow: hidden;"><img src="http://wplms.io/demos/demo1/wp-content/uploads/2018/05/alpha.png" /></p>
						
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4>Course Application Forms</h4>
						<p style="max-height: 320px; overflow: hidden;">
							<img src="https://image.prntscr.com/image/rzfiqS-SRDGHe558WB9ArQ.png">
						</p>
						<p>Invite user applications for Course enrollment.</p>
						<a href="https://wplms.io/downloads/wplms-application-forms/" class="button" target="_blank">Purchase Link</a>
					</div>
					<div>
						<h4>App User Wallets</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://image.prntscr.com/image/G3h7Bu0USoqAf4m5osVYFw.png">
						</p>
					</div>
					<div class="last-feature">
						<h4>Different Actication emails per registration form</h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="https://image.prntscr.com/image/pRPsxxh3RhWo2Z4JwhEFSw.png" /></p>
						<a href="https://wplms.io/support/knowledge-base/custom-registration-emails-for-registration-forms" class="button">Tutorial</a>
					</div>
			...
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4>Coming up WPLMS Chat !</h4>
						<p>Yes, the Chat plugin for your WPLMS site will be available very soon. Online status, Group Chat, Instructor Chat, Course chat and a whole lot of chat related features.</p>
					</div>

					<div>
						<h4>WPLMS User Application Forms</h4>
						<p>A Plugin to invite user applications before they enroll in the course, this functionality is clubbed with already existing Apply to enroll.</p>
						<a href="<?php echo admin_url('admin.php?page=lms-settings&tab=addons'); ?>" class="button">Download</a>
					</div>
