...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.2.9.4.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '2.9.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/woocommerce.3.3.5.zip', // The plugin source
