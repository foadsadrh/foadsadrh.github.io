<?php
load_theme_textdomain( 'wplms-front-end', get_template_directory().'/languages' );
load_theme_textdomain( 'vibe', get_template_directory().'/languages' );
load_theme_textdomain( 'buddydrive', get_template_directory().'/languages' );
load_theme_textdomain( 'buddypress', get_template_directory().'/languages' );

function load_custom_wp_admin_style() { wp_register_style( 'custom_wp_admin_css', get_template_directory_uri() . '/admin-rtl-midiyaweb.css', false, '1.0.0' ); wp_enqueue_style( 'custom_wp_admin_css' );}add_action( 'admin_enqueue_scripts', 'load_custom_wp_admin_style' );
