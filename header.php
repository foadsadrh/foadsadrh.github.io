...
<div id="main_container">
    ...
    <!--
        ...
        <form role="جستجو..." method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
        <input type="text" name="s" id="s" value="جستجو..." onclick="if(this.value == 'جستجو...') this.value='';" onblur="if(this.value == '') this.value='جستجو...';" />
        </form>
